...
// and each tool call, start / success / failure. This is the progress
// heartbeat that also gives an operator a record to check for suspicious
// tool activity after the fact.
