...
/** `moduleDir` is this file's directory: <lab>/cli/src/config. */
export function loadConfig(env: NodeJS.ProcessEnv, moduleDir: string): LabConfig {
  return {
    ...
    corpusDir: env.CORPUS_DIR ?? resolve(moduleDir, "..", "..", "..", "corpus"),
  };
}
